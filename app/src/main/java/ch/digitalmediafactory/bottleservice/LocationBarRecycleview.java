...
public class LocationBarRecycleview {
    LocationBarRecycleview(){}
    ...
    public LocationBarRecycleview(String locationTitle, String locationSlider, String locationMap, String ownerUserID) {
