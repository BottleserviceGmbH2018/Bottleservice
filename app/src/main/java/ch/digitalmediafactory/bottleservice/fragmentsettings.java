...
public class fragmentsettings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fragmentsettings, container, false);

        ImageView settingAbout = (ImageView)view.findViewById(R.id.settingAbout);
        settingAbout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntent = new Intent(getContext(), ClientImpressum.class);
