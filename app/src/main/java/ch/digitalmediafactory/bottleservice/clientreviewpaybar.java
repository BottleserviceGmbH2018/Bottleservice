...
public class clientreviewpaybar extends AppCompatActivity {

    DatabaseReference mUsersDatabase, mReservationDatabase, mDatabase, mDatabaseRequest, mDatabaseReserve, mDatabaseRequestOwner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clientreviewpaybar);
        ...
        mUsersDatabase = FirebaseDatabase.getInstance().getReference().child("Location_Specific").child("Bar").child(locationid).child(locationame).child(locationtitle);
        ...
        bPayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabaseRequestOwner = FirebaseDatabase.getInstance().getReference().child("Reservation_OwnerSide").child(locationid).child("Bar").child(locationame);
...
//                        Fragment fragment = new fragmentbookings();
...
//                        transaction.commit();
                        ...
                        clientreviewpaybar.this.finish();
